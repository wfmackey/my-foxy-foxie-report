\documentclass[embargoed]{grattan} yayyyyy

% Key notes: 
% 		- 	please do not put comments before \documentclass
% 		- 	full documentation for grattex is contained in: 
% 			doc/grattexDocumentation.pdf

% Summary of alternative options for \documentclass[]------------------

% 	Embargoed report (the default):
...
% 		- 	Change \acknowledgements opening line to read 'This working paper was written by...'
...
% 		-	Add the MONTH and YEAR to \subtitle{}, eg \subtitle{July 2022}
...
\GrattanReportNumber{2022-00} % Request a report number from admin, eg 2022-08
\MONTH{July}
...
% editorial_author_only: Foxie Fox
% The command above says `this person is not an author to be cited'. It prevents staff who are acknowledged in the \acknowledgments{} from being included in the citation.


% Point to bib file(s) ------------------------------------------------
% repeat the addbibresource command to add more than one bib file
\addbibresource{bib/put-new-refs-here.bib}


% Back-end settings ---------------------------------------------------
% Adjust vertical alignment of Table of Contents title
\setlength{\cftbeforetoctitleskip}{4em}
% \setlength{\cftbeforeloftitleskip}{4em}
% \setlength{\cftbeforelottitleskip}{4em}

% Shift acknowledgements page up to allow for more text:
% (more negative shifts the titles up, creating more space)
\renewcommand{\Vshiftacknowledgements}{0mm}
\renewcommand{\Hshiftacknowledgements}{0mm}
...
\author{Danielle Wood, Kate Griffiths, and Esther Suckling}
% Contributing associates are allowed to be named on front covers at the discretion of the PD



\acknowledgements{%
This report was written by Danielle Wood, Kate Griffiths, and James Ha. % Note: no job titles required here. An Oxford comma is required.
Will Mackey provided extensive research assistance and made substantial contributions to the report.
% Remember to thank interns who worked on this report.

We would like to thank the members of Grattan Institute's XXXXX Program Reference Group for their helpful comments, as well as numerous government and industry participants and officials for their input.
...
We aim to improve policy by engaging with decision makers and the broader community.

We acknowledge and celebrate the First Nations people on whose traditional lands we meet and work, and whose cultures are among the oldest continuous cultures in human history.

For further information on Grattan's programs, or to join our mailing list, please go to: \textcolor{blue}{\url{www.grattan.edu.au/}}. You can make a donation to support future Grattan reports here: \textcolor{blue}{\url{www.grattan.edu.au/donate}}.

{\footnotesize
This report may be cited as:
Wood, D., Griffiths, K., and Suckling, E\@. (2022). \emph{\mytitle}. Grattan Institute.

ISBN: 000-0-0000000-0-0 % Request an ISBN from admin
...
Sometimes when you have tall figures and detailed notes, you might want space for your \texttt{doublecolumnfigures}. You can use \verb|\talldoublecolumnfigure|.
...
The bibliography appears after the appendix. 
